...
\usetikzlibrary{decorations.pathmorphing,arrows,arrows.meta,calc,shapes,shapes.geometric, decorations.pathreplacing,}
...
%\item Reprenons l'inégalité précédente. Puisque $|\sin \left( \frac{\pi}{2} - \varepsilon \right)|<1$, il existe $n_0 \in\mathbb{N}$ tel que, pour $n \geqslant n_0$, on a : 
