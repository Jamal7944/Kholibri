...
class AjouterClasse(Frame):
    """
    Classe de la fenêtre pour ajouter une classe dans la base de données.
    """
    ...
    def ajouterClasse(self):
        """
        Fonction permettant de passer au choix des chapitres apèrs avoir choisi le nom de la nouvelle classe.
        """
    ...
    def afficherClasse(self):
        """
        Fonction permettant d'afficher dans un champ de texte l'ensemble des classes présentes dans la base.
        """
        if self.cadre2.winfo_manager() :
            self.cadre2.pack_forget()
            self.buttonAfficher["text"] ="Afficher l'ensemble des chapitres"
    ...
    def ActualiseAffichageClasse(self) :
        """
        Fonction permettant de mettre à jour l'affichage des classes dans la liste.
        """
    ...
    def ajouterChap(self):
        """
        Fonction permettant de faire le choix des chapitres à ajouter dans la classe.
        """
    ...
    def valider(self):
        """
        Fonction permettant d'ajouter les choix effectués dans la base de données.
        """
    ...
    def supprimerChap(self) :
        """
        Fonction permettant de supprimer un chapitre de la classe.
        """
        chapSuppr = 0
