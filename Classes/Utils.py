...
class Utils():
    """
    Cette classe contient un ensemble de fonctions et de variables utilisés de nombreuses fois à travers l'application
    """
    ...
    """
    les tags représentants les couleurs de la coloration syntaxique
    """
    ...
    """
    les mots a colorés selon le tag associé
    """

    @staticmethod
    def check(champ, index, pre, post):
        """
        Permet la vérification des mots du champ passé en parmètres pour la coloration syntaxique

        Parameters
        ----------
        champ : le champ dans lequel effectuer la coloration syntaxique
        index : l'index
        pre
        post
    ...
    def open_file(champ):
        """
        fonction permettant de demander à l'utilisateur le choix d'un fichier
